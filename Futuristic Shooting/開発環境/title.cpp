...
// グローバル変数
//=============================================================================
LPDIRECT3DTEXTURE9 g_pTextureTitle[3] = {};		//テクスチャへのポインタ
...
HRESULT InitTitle(void)
{
	...
	//テクスチャの読み込み
	D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/bg000.png", &g_pTextureTitle[0]);
...
void SetTextureTitle(int nCntTitle)
{
	...
	{
		//頂点座標
		pVtx[0].pos = D3DXVECTOR3(480, 500, 0.0f);	//Zは0.0固定
		pVtx[1].pos = D3DXVECTOR3(480, 100, 0.0f);
		pVtx[2].pos = D3DXVECTOR3(1440, 500, 0.0f);
