...
HRESULT CTitle::Init(D3DXVECTOR3 pos, D3DXVECTOR3 size)
{
	...
	// 戦闘機 gif
	CAnimation::Create(D3DXVECTOR3(150.0f, 120.0f, 0.0f), D3DXVECTOR3(300.0f, 240.0f,0.0f), 8, 1);
//	CAnimation::Create(D3DXVECTOR3(1100.0f, 550.0f, 0.0f), D3DXVECTOR3(200.0f, 160.0f, 0.0f), 10, 2);
