...
HRESULT CAnimation::Load(void)
{
	...
	D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/gif_anim000.png", &m_pTexture[1]);
	D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/gif_anim001.png", &m_pTexture[2]);
